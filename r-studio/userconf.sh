...
echo "USER is now $USER with UID $USERID"
...
chown -R $USER /home/$USERF

## Execute exasol.sh once /home/$USER is setup in order to copy .odbc.ini to $USER home dir
sh /usr/bin/exasol.sh
